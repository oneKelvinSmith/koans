...
EOS
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    # - += might traditionally be associated with numerical operations
    # - << seems easier to read and by modifying the original string
    # - fewer variables can be used.
  end
  ...
  def test_you_can_get_a_single_character_from_a_string
    ...
    # Surprised?
    # - No. Most array idices are 0 based, i.e. start from 0.
  end
